...
import pytest
from flare_protobuf_plugin import additional_fields
from flare_protobuf_plugin.python_protobuf_subsystem import PythonProtobufMypyPlugin
from flare_protobuf_plugin.python_protobuf_subsystem import rules as protobuf_subsystem_rules
from flare_protobuf_plugin.rules import GeneratePythonFromProtobufRequest
from flare_protobuf_plugin.rules import rules as protobuf_rules
...
def test_grpclib(rule_runner: RuleRunner) -> None:
    rule_runner.write_files(
        {
            "src/protobuf/dir1/f.proto": dedent(GRPC_PROTO_STANZA),
            "src/protobuf/dir1/BUILD": "protobuf_sources(grpc=True, python_protoc_plugin='grpclib')",
        }
    )
    assert_files_generated(
        rule_runner,
